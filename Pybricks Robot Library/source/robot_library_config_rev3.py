...
class RobotConfig:
    ...
    def __init__(self,HubName,HubNumber):
        ...
        self.LeftDriveMotorPort=Port.A
        self.RightDriveMotorPort=Port.B
        #
...
robotConfigs[0].LeftDriveMotorPort=Port.A
robotConfigs[0].RightDriveMotorPort=Port.B
#
...
robotConfigs[1].LeftDriveMotorPort=Port.A
robotConfigs[1].RightDriveMotorPort=Port.B
#
...
robotConfigs[2].LeftDriveMotorPort=Port.A
robotConfigs[2].RightDriveMotorPort=Port.B
#
